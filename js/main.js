require([], function (){
	...
	var colorList = ["#6da336", "#ff945c", "#66CC66", "#99CC99", "#CC6666", "#76becc", "#c99979", "#918597", "#4d4d4d"];
 	...
 	//随机背景图片
 	var backgroundList = ["url(/img/bg-1.jpg)", "url(/img/bg-2.jpg)","url(/img/bg-3.jpg)","url(/img/bg-4.jpg)","url(/img/bg-5.jpg)","url(/img/bg-6.jpg)","url(/img/bg-7.jpg)","url(/img/bg-8.jpg)","url(/img/bg-9.jpg)","url(/img/bg-10.jpg)","url(/img/bg-11.jpg)","url(/img/bg-12.jpg)","url(/img/bg-13.jpg)","url(/img/bg-14.jpg)","url(/img/bg-15.jpg)","url(/img/bg-16.jpg)","url(/img/bg-17.jpg)","url(/img/bg-18.jpg)"];
